...
<div class="accordion divide-neutral/20 max-w-lg divide-y">
  <AccordionItem
    ...
    content="Payment is taken during the checkout process when you pay for your
  ...
  <AccordionItem
    ...
    content="For large products, we deliver your product via a third party
            logistics company offering you the “room of choice” scheduled
            delivery service. For small products, we offer free parcel delivery."
  />
  <AccordionItem
    title="Can I cancel my order?"
    content="Scheduled delivery orders can be cancelled 72 hours prior to your
